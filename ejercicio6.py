...
#             if self.antiguedad == Antiguedad.DE_DOS_A_CINCO:
#                 salario *= 1.05
#             elif self.antiguedad == Antiguedad.MAS_DE_CINCO:
#                 salario *= 1.10
#             return salario
...
# empresa = Empresa()
# empresa.agregar_empleado(Empleado("11111111", "Juan", "Perez", 2019, Categoria.SALARIO_FIJO, 2, 200, 10000, 20000, Antiguedad.MAS_DE_CINCO ))
# empresa.agregar_empleado(Empleado("22222222", "Maria", "Gomez", 2018, Categoria.SALARIO_FIJO, 2, 200, 10000, 20000, Antiguedad.MENOS_DE_DOS))
...
# empresa.agregar_empleado(Empleado("55555555", "Luis", "Rodriguez", 2016, Categoria.SALARIO_FIJO, 2, 200, 10000, 20000, Antiguedad.DE_DOS_A_CINCO))
# empresa.agregar_empleado(Empleado("66666666", "Laura", "Diaz", 2021, Categoria.A_COMISION, 25, 200, 10000, 20000, 0))
# empresa.agregar_empleado(Empleado("77777777", "Pedro", "Sanchez", 2015, Categoria.SALARIO_FIJO, 2, 200, 10000, 20000, Antiguedad.MAS_DE_CINCO))
# empresa.agregar_empleado(Empleado("88888888", "Sofia", "Fernandez", 2019, Categoria.A_COMISION, 8, 200, 10000, 20000, 0))
# empresa.agregar_empleado(Empleado("99999999", "Diego", "Garcia", 2018, Categoria.SALARIO_FIJO, 2, 200, 10000, 20000, Antiguedad.MENOS_DE_DOS))
